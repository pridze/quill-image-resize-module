...
var Toolbar = function (_BaseModule) {
    ...
    function Toolbar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            var Parchment = _this.quill.constructor.imports.parchment;
...
var ImageResize = function ImageResize(quill) {
    ...
    this.getQuillClass = function () {
        return _this.quill.constructor;
    };
    ...
    this.handleClick = function (evt) {
        if (evt.target && evt.target.tagName && evt.target.tagName.toUpperCase() === 'IMG') {
            // read-only callback
            if (_this.quill.root.getAttribute('contenteditable') === 'false') {
                _this.options.readOnlyCallback(evt.target);
                return;
            }
    ...
    this.checkImage = function (evt) {
        if (_this.img) {
            if (evt.keyCode == 46 || evt.keyCode == 8) {
                _this.getQuillClass().find(_this.img).deleteAt(0);
            }
            _this.hide();
        }
    };
